...
# ����� ��������
tr_te$�����.��������� = period_to_seconds(hms(tr_te$�����.���������))
tr_te$�����.����������� = period_to_seconds(hms(tr_te$�����.�����������))
tr_te$delta_sleep = ifelse(tr_te$�����.����������� - tr_te$�����.��������� < 0, 
                           24*3600 + tr_te$�����.����������� - tr_te$�����.���������, tr_te$�����.����������� - tr_te$�����.���������)
for (i in c(as.numeric(which(sapply(tr_te, "class") == 'character')[-c(1)])))
  tr_te[,i] = as.numeric(as.factor(tr_te[,i]))
tr_te$bad_time = ifelse(is.na(tr_te$�������.�����) == T, 0,tr_te$�������.�����) +
  ifelse(is.na(tr_te$�������.�������) == T, 0,tr_te$�������.�������)
tr_te$cig = tr_te$�������.������� * tr_te$�������.�.����
...
# ��� ������� ������� ���������� ����������� ����� �������� lgb � ����������� ���� ��� ����������� logloss �� CV
dtrain <- lgb.Dataset(as.matrix(train[-c(exclude)]),label = target$������������.�����������)
...
for (j in c(1:5)) { 
  ...
  for (k in c(1:10000)) {
    ...
    rec1 = sum(pr_disc == 1 & 
                 target[train$fold == j,]$������������.����������� == 1)/sum(target[train$fold == j,]$������������.����������� == 1)
    rec0 = sum(pr_disc == 0 & 
                 target[train$fold == j,]$������������.����������� == 0)/sum(target[train$fold == j,]$������������.����������� == 0)
...
sub4 = data.frame(ID = test$ID, 
                  `������������.�����������` = ifelse(pr_all1 > thresh$k[1], 1, 0),
                  `����` = ifelse(pr_all2 > thresh$k[2], 1, 0),
                  `�����������..���..�������.��������` = ifelse(pr_all3 > thresh$k[3], 1, 0),
                  `���������.���������������` = ifelse(pr_all4 > thresh$k[4], 1, 0),
                  `������.�����������.������` = ifelse(pr_all5 > thresh$k[5], 1, 0))
